    ...
    while($r=mysql_fetch_array($tampil)){
      ...
      echo "<tr><td><input type=checkbox name=cek[] value=$r[id_orders] id=id$no></td>
                ...
                <td>$r[status_order]</td>
		            <td><a href=?module=order&act=detailorder&id=$r[id_orders] class='btn btn-success'><b>Baca</b></a> 
		                <a href=$aksi?module=order&act=hapus&id=$r[id_orders] class='btn btn-danger'><b>Hapus</b></a></td></tr>";
      $no++;
    }
	           
    echo "<tr><td colspan=7 align=center>
<input class='from-control' type=radio name=pilih onClick='for (i=0;i<$no;i++){document.getElementById(\"id\"+i).checked=true;}'>Check All 
<input class='from-control' type=radio name=pilih onClick='for (i=0;i<$no;i++){document.getElementById(\"id\"+i).checked=false;}'>Uncheck All 

</td></tr>
<tr><td colspan=7 align=center><input type=submit class='btn btn-success' value=Hapus></td>
</tr></table></form>";
  ...
  case "detailorder":
    ...
    echo "<h2>Detail Order</h2>
          ...
          <tr><td>Status Order      </td><td> <select class='form-control' name=status_order>$pilihan_order</select> <br>
          <input class='btn btn-success' type=submit value='Ubah Status'></td></tr>
          </table></form>";
